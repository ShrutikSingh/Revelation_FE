...
const Rules = () => {
  ...
  return (
    <div id="ruless" className="bg-black  text-white p-6 rounded-lg border border-[#8D8D8D]-500 max-w-2xl mx-auto mt-20 max-md:mt-[30px] max-md:mb-[600px] text-center">
